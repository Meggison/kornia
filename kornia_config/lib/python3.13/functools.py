...
from _functools import _lru_cache_wrapper, cmp_to_key, partial, reduce
...
def _compose_mro(cls, types):
    ...
    def is_related(typ):
        return (
            typ not in bases and hasattr(typ, "__mro__") and not isinstance(typ, GenericAlias) and issubclass(cls, typ)
        )
